  ...
  <div class="home">
    <div v-if="!found" class="d-flex flex-column align-items-center justify-content-center" style="margin: 25vh 0">
      ...
      <vue-typer v-if="value >= 101"
        :text='["Wait...thats not right...", "This isnt supposed to happen...", "Okay...theres actually a secret buton..."]' :repeat='0' :shuffle='false' initial-action='typing' 
    ...
    <div v-if="found">
      <nav v-if="gameComplete" >
        ...
        <router-link to="/progress">Contribute</router-link>
      </nav>
      ...
      <div v-if="gameComplete">
        ...
        <br>
        <vue-typer
          :text='[`Your total time was ${totalTimeMs / 100} seconds`]' :repeat='0' :shuffle='false' initial-action='typing' 
  ...
  methods: {
    startTimer() {
      ...
      let timer = setInterval(function() {
          ...
          if (vm.value >= 93 && !this.found) clearInterval(timer);
      }, 80);
